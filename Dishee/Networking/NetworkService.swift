...
//    }
    ...
    private func request<T: Decodable>(route: Route,
        ...
        guard let request = createRequest(route: route, method: method,
        ...
        URLSession.shared.dataTask(with: request) {data, response, error in
            ...
            if let data = data {
                result = .success(data)
                let responseString = String(data: data, encoding: .utf8) ?? "Counld not stringfy our datas"
    ...
    ///   - method: tyoe of reqest to be made
    ...
    private func createRequest(route: Route,
        ...
        if let params = parameters {
            ...
            case .post, .delete, .patch:
                let bodyData = try? JSONSerialization.data(withJSONObject: parameters as Any, options: [])
